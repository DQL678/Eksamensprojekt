...
class GameApp:
    ...
    def update_auto_fire(self):
        if not self.player or not self.mouse_held or self.player.current_weapon is None:
            return
    ...
    def draw_join_screen(self):
        ...
        if self.connection_error:
            err = self.text_font.render(self.connection_error, True, (220, 60, 60))
            err_rect = err.get_rect(center=(self.screen_width // 2, int(self.screen_height * 0.65)))
